...
highconfidence=train[train['sentiment_confidence']<0.4]


# In[176]:


highconfidenceCha=challenge[challenge['sentiment_confidence']<0.4]


# In[177]:


train[train['review_text']=='#NAME?']


# In[178]:


analyze_highconfidence = sv.analyze(highconfidence)
analyze_highconfidence.show_html('highconfidence.html')
